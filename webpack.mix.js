...
/*
 ...
 | -----------------------------------------------
 | Using your view with mix('css/profound.css', 'vendor/profound')
...
mix
    .postCss('resources/css/profound.css', 'css', [require('tailwindcss')('tailwind.config.js')])
    .js('resources/js/profound.js', 'js')
    .version()
